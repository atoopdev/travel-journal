...
const tripCard = (props) => {
    const image = props.trip.imageURL
    console.log(image)
    return (
        <div className="trip-card">
            ...
            <div className="location">
                ...
                <h2 className="trip-location">{props.trip.location}</h2>
                <a href={props.trip.googleMapsUrl}className="location-link">View on Google Maps</a>
            </div>
